      ...
      <div className="welcome-grid">
        <div className="welcome-left">
          ...
          <div className="welcome-cta">
            ...
            <span className="mono text-gray" style={{ fontSize: '0.8rem' }}>
        ...
        <div className="welcome-right">
          <div className="welcome-card-stack">
            <div className="hero-stat-card">
              ...
              <div className="mono text-gray" style={{ fontSize: '0.75rem', marginTop: 6 }}>
                72% complete · Python Beginner
              </div>
            </div>
            ...
            <div className="daily-preview">
              <div className="mono text-gray" style={{ fontSize: '0.7rem', marginBottom: 12 }}>
                TODAY'S PLAN
              </div>
